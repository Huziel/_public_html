...
$query = "INSERT INTO `data` (`id`, `number`, `keyy`, `link`, `session`, `dscr`) VALUES (NULL, '$serial', '$name', '$link', '$session', '$dscr');";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td style="color: black;"><?php echo $arreglo[5]; ?>
                        <td style="color: black;"><?php echo $arreglo[2]; ?>
                            ...
                            <center>
                                <form id="sendBP<?php echo $arreglo[0] ?>" action="./objets/borrarP.php" method="POST">
                                    ...
                                    <input type="hidden" value="<?php echo $arreglo[4]?>" name="session" >
