<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootswatch/5.3.2/cyborg/bootstrap.min.css" integrity="sha512-RfNxVfFNFgqk9MXO4TCKXYXn9hgc+keHCg3xFFGbnp2q7Cifda+YYzMTDHwsQtNx4DuqIMgfvZead7XOtB9CDQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<footer class="py-3 fixed-bottom darkCristal">
    <center>
        <div class="container row text-primary">
            <div class="col-3">
                <center><a href="https://rutadelaseda.xyz/" class="botonF1 text-warning"> <i class="fas fa-store fa-2x"></i></a></center>
            </div>
            <div class="col-3">
                <center> <a href="https://wa.me/+52<?= $wha ?>" class="botonF1 text-warning" target="_blank"> <i class="fab fa-whatsapp fa-2x"></i></a></center>
            </div>
            <div class="col-3">
                <center> <a href="https://www.google.com/maps/place/<?= $lat ?>,<?= $long ?>" class="botonF1 text-warning" target="_blank"> <i class="fas fa-map-marker-alt fa-2x"></i></a></center>
            </div>
            <div class="col-3">
                <center>
