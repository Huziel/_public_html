<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootswatch/5.3.2/vapor/bootstrap.min.css" integrity="sha512-pPmST8gBh1KmMbf1Hzpj0UyqNqwK+l3fVAHfn88gsw0ArhmguElOC3PIfmPrnZmd8wYldC9Q5q7WPsCHPlvhPA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="css/page.css">
    <style>
        .darkCristal {
            /* From https://css.glass */
            background: rgba(8, 88, 228, 0.12);
            border-radius: 12px;
            box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);
            backdrop-filter: blur(8.5px);
            -webkit-backdrop-filter: blur(8.5px);
            border: 1px solid rgba(8, 88, 228, 0.12);
        }
    </style>
</head>
...
<nav class="navbar navbar-expand-lg darkCristal fixed-top" data-bs-theme="dark">
...
<footer class="py-3 fixed-bottom darkCristal">
    <center>
        <div class="container row text-primary">
            <div class="col-3">
                <center><a href="https://rutadelaseda.xyz/" class="botonF1 text-danger"> <i class="fas fa-store fa-2x"></i></a></center>
            </div>
            <div class="col-3">
                <center> <a href="https://wa.me/+52<?= $wha ?>" class="botonF1 text-danger" target="_blank"> <i class="fab fa-whatsapp fa-2x"></i></a></center>
            </div>
            <div class="col-3">
                <center> <a href="https://www.google.com/maps/place/<?= $lat ?>,<?= $long ?>" class="botonF1 text-danger" target="_blank"> <i class="fas fa-map-marker-alt fa-2x"></i></a></center>
            </div>
            <div class="col-3">
                <center>
                    ...
                    <form>
                        <button type="button" data-bs-toggle="modal" onclick="viewTable()" data-bs-target="#exampleModal2" class="botonF1 text-success animate__animated animate__heartBeat animate__infinite infinite">
                            <span>
    ...
    <div class="modal-dialog modal-xl " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                    <form action="localizador.php" target="_blank" method="get">
                        ...
                        <button type="submit" class="btn btn-warning btn-block  animate__animated animate__pulse animate__infinite infinite">
                            <span>
            ...
            <div class="modal-footer">
                ...
                <a name="" id="" class="btn btn-primary  btn-block" href="smarticket.php" role="button">¿Ya tiene una orden en proceso?</a>
...
<script>
    ...
    function cambiarThema() {
        $('#productsPageLoader').removeClass('bg-light');

        // Agregar una nueva clase
        $('#productsPageLoader').addClass('darkCristal');
    }
