<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootswatch/5.3.3/lumen/bootstrap.min.css" integrity="sha512-N6Wwrw2+w72hDf55YI/j+y3JUXpO7qTuo+kilvcpFJqEabBFA3nurVZineUcg4+op0dJLrzQXcNNif9Gf/ECPA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <style>
        .carousel-inner img {
            ...
            height: auto;
            border-radius: 15px;
            /* Aplicando bordes redondeados a las imágenes del slider */
        }

        .carousel {
            border-radius: 15px;
            /* Aplicando bordes redondeados al contenedor del slider */
            overflow: hidden;
            /* Para asegurarse de que las imágenes redondeadas no sobresalgan del contenedor */
        }

        .container-video {
            border-radius: 15px;
            /* Aplicando bordes redondeados al contenedor de video */
            overflow: hidden;
            /* Para asegurarse de que el video redondeado no sobresalga del contenedor */
        }
    </style>
</head>
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" onclick="viewPList()" href="#listadeproductos"><?= $arreglo[0] ?>Todo</a>
                    <div class="dropdown-divider"></div>
                    <?php
                    while ($arreglo = mysqli_fetch_array($sqlCat)) {
                    ?>
                        <a class="dropdown-item" href="#listadeproductos" onclick="viewPList('<?= $arreglo[0] ?>')"><?= $arreglo[0] ?></a>
                    <?php
                    }
                    ?>
                </div>
            ...
            <div class="embed-responsive embed-responsive-16by9">
                <div class="container-video">
                    <video id="miVideo" autoplay muted loop>
                        <source src="images/vapers/WhatsApp Video 2024-03-11 at 9.02.08 PM.mp4" type="video/mp4">
...
<div class="container">
                    ...
                    <center> <h1>Productos 100% originales</h1></center>
                    <br>

    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" style="border-radius: 16px;">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/vapers/1.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="images/vapers/2.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="images/vapers/3.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="images/vapers/5.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="images/vapers/5.png" class="d-block w-100" alt="...">
            </div>
    ...
    <br>
    <center> <h4 class="text-secondary">¡Sumérgete en el emocionante mundo de las marcas de renombre y despierta tu curiosidad explorando su fascinante universo!</h4></center>
                    <br>

</div>


<div class="viewPList" id="listadeproductos"></div>
