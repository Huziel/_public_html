...
<div class="container table-responsive">
    ...
    <tr class="bg-success">
        ...
        <td>
            <div id="countPr" class="h5 text-primary"></div>
        </td>
        <td></td>
    </tr>
    ...
    <tr class="bg-success">
        ...
        <td>
            <div id="totT" class="h5 text-primary"></div>
        </td>
    ...
    <div class="alert alert-danger" role="alert">
        <strong>Hay productos que sobrepasan la existencia de stock de la tienda, puede que tengas que reajustar el pedio o esperar a que el vendedor se ponga en contacto con usted.</strong>
    </div>
    <?php
    }
    ?>
