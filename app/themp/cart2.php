 ...
 */
    ...
    <a href=" https://rutadelaseda.xyz/@<?= $idStore ?>" class="btn btn-dark">
        ...
        <br>
        <center>
            <button type="button" id="buttonsPay" class="btn btn-secondary  btn-lg mb-2" data-bs-toggle="modal" data-bs-target="#pedido_modal">
                <?php
                if ($precioBase == 0) {
                ?>
                        ...
                        <div class="form-group">
                            ...
                            <div id="formulario" class="formulario">
                                ...
                                <div class="d-grid gap-2">
                                    <button type="button" name="btnOrder" id="btnOrder" onclick="OrderCProduct()" class="btn btn-secondary">
                                        Confirmar
                                    </button>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <br>
                                    <div class="alert alert-secondary textoRancio text-primary" role="alert">
