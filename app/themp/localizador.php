...
<body>
    ...
    <div class="" id="pac-card" style="border-radius: 12px; background-color: white;">
        ...
        <div>
            <div id="title" class="bg-secondary">Dirección del destino <i class="fa-solid fa-location-dot"></i></div>
            ...
            <script>
                function showCart() {
                    ...
                    if (parametro2 && parametro3) {
                        const url = `cart.php?id=${parametro1}&parametro2=${parametro2}&parametro3=${parametro3}&parametro4=${"<?=$prelat?>"}&parametro5=${"<?=$prelong?>"}`;
